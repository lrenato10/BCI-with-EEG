...
EEG=ConcatenateDataSetEEG( ID_inicial=4 , ID_final=4 , Remove_EOG=True, Bands='unica', Feature='NE') #Bands ('AB', 'A','B', 'AB/', 'todas' ou 'unica') Feature ('WAMP', 'RMS', 'duplo','NE' , 'LL' ou 'PSD')
