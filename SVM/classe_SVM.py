...
class mySVM():
    ...
    def treinar(self):
        self.X_train, self.X_test, self.Y_train, self.Y_test = train_test_split(self.E,self.label,test_size=0.3)#separa dados de treinamento e validacao com 20% de validacao
